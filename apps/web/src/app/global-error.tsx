...
export default function GlobalErrorPage({ error, reset }: GlobalErrorPageProps) {
  return (
    <html lang='fa' dir='rtl'>
      <head>
        <title>خطای جدی در بارگذاری سایت | پارت‌سنج</title>

        <meta
          name='description'
          content='خطایی در بارگذاری سایت پارت‌سنج رخ داده است. لطفاً دوباره تلاش کنید.'
        />
      ...
      <body>
        <main className='relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4 py-10'>
          ...
          <section
            ...
            className='relative w-full max-w-2xl rounded-[32px] border border-border bg-surface p-6 text-center shadow-panel sm:p-10'
          >
            <div className='mx-auto flex size-24 items-center justify-center rounded-[28px] bg-brand-soft text-brand shadow-sm'>
              <AlertOctagon aria-hidden='true' className='size-12 stroke-[1.7]' />
            </div>

            <h1
              id='global-error-title'
              className='mt-8 text-3xl leading-[1.7] font-black text-foreground sm:text-4xl'
            >
